# spectr
spectr is a tool for analysing captured signals, primarily from software-defined radio receivers.
...
## Input
spectr supports the following file types:
...
If an unknown file extension is loaded, spectr will default to `*.cf32`.

Note: 64-bit samples will be truncated to 32-bit before processing, as spectr only supports 32-bit internally.
